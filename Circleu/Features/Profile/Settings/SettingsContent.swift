...
The information you create may be used to:
...
Share experiences, offer encouragement, and support others without judgement.
...
AI may occasionally make mistakes or provide incomplete insights.

We believe users should always understand when AI is being used and remain in control of their own decisions, experiences, and personal growth.
...
If you are experiencing significant emotional distress, mental health concerns, or a crisis situation, we encourage you to seek support from qualified professionals, trusted individuals, or local support services.

BE KIND TO YOURSELF

Growth takes time.

Reflection is not about being perfect — it is about learning, understanding, and moving forward.
...
Voice allows users to express thoughts and emotions naturally, making reflection more accessible and personal.

IS MY REFLECTION PRIVATE?

Your reflections are intended to support your personal growth experience. You remain in control of what you choose to save or share.
...
AI helps identify themes, emotions, and opportunities for growth within reflections and may provide supportive suggestions.
...
🛡 Safety
Users should feel supported, respected, and in control of their experience.
...
We would like to thank the University of Technology Sydney (UTS) for providing the learning environment, resources, and support throughout the program.

MENTORS AND FACILITATORS

Special thanks to our mentors, facilitators, and instructors for their guidance, feedback, and encouragement throughout the development process.
